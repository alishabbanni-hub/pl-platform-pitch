...
// Everything in phase 2 — pentagon zoom-out, arrow draw, circle appear,
// camera pan — starts at the SAME moment so it reads as one fluid motion.
// The camera pan keeps running until the new circle has fully appeared.
const CAMERA_PAN_DELAY_MS = 0;                          // start immediately, in sync with the pentagon
